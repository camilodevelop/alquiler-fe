-- ============================================================
-- MÓDULO MANTENIMIENTO — Supabase SQL Editor
-- Requiere: profiles, propiedades, inquilinos, helpers acceso
-- ============================================================

-- Módulo Mantenimiento (tickets + manitas)
-- ==========================================
-- Nota: las funciones user_can_access_* van DESPUÉS de crear las tablas.
...
-- ------------------------------------------
-- Historial de trabajos manitas (manual + vínculo ticket)
-- ------------------------------------------
